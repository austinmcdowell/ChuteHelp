...
<html lang="{{ app()->getLocale() }}">
    ...
    <meta charset="utf-8">
        ...
        <link href="{{ asset('css/option-two.css') }}" rel="stylesheet" type="text/css">
    ...
    <body>
        ...
        <img src="{{ asset('img/bck-dark.jpg') }}" alt="Responsive image" class="image-fluid" style="max-width: 100%">
            ...
            <div class="caption-two">
                ...
                <h1 class="display-2">Chute Help</h1>
        ...
        <div class="row">
            <div class="opener">
                ...
                <!-- <div align="center" class="embed-responsive embed-responsive-16by9 chute-help-video" >
                    <video autoplay loop class="embed-responsive-item">
                        <source src="{{ asset('img/chute.mov') }}" type="video/mp4" autostart="1" >
                    </video>
                </div> -->
                <div class="row video-title">
                    <div class="col-lg-6">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/wJJzWpmH7QA"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h2>Product</h2>
                        <h1>Chute Help Farm Gate</h1>
...
Chute Help's lead ups are all equipped with dual alley stops, making sorting and loading simple.  The dual alley stops make the steer's transition from one section to the next smooth and steady.
                    ...
                    <div class="col-lg-6">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/FZj1mpDU7zI"></iframe>
                        </div>
                    </div>
                </div>
                ...
                <div class="row video-title">
                    <div class="col-lg-6">
                        <div class="embed-responsive embed-responsive-16by9">
                            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/2NkdlMSmLZ4"></iframe>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <h2>Story</h2>
                ...
                <div class="row icon-sections">
                    <div class="col-lg-4 chute-desc-col">
                        <a href="#" class="btn btn-primary page-button">Contact</a>
                    </div>
                    <div class="col-lg-4 chute-desc-col">
